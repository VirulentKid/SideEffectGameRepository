...
public class PlayerController : MonoBehaviour
{
    ...
    void SetAnimations()
    {
        ...
        currentAnimationStateHash = animationStateInfo.shortNameHash;

        string[] animationNames = new string[] { IDLE, WALK, ATTACK1, ATTACK2 };
        ...
        if (!attacking)
        {
            ...
            { animationName = (WALK); }
            AnimatorStateInfo nextAnimationStateInfo = animator.GetNextAnimatorStateInfo(layerId);
            if (animationName != null && !nextAnimationStateInfo.IsName(animationName))
            {
    ...
    public void Attack()
    {
        ...
        skillGenerator.GenerateSkill(skillRuntimeData);
    ...
    //            {
    //                T.ReceiveDamage(gameObject, attackDamage);
    //                break;
    //            }
